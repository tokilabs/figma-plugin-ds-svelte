...
> Based on the awesome work of [thomas-lowry](https://github.com/thomas-lowry) in [figma-plugin-ds-svelte](https://github.com/thomas-lowry/figma-plugin-ds-svelte)
We plan to improve documentation and expend it besides components.

### WORK IN PROGRESS

This is still a work in progress. Here's the roadmap:

- [x] Adopt SvelteKit and Vite
- [x] Convert to typescript
- [ ] Publish an NPM package
- [ ] Add Storybook documentation
- [ ] Publish a Figma file with design tokens and variables
- [ ] Update the Figma file with reusable components
- [ ] Create a project template repository

# Figma Plugin DS Svelte [The Original README]
